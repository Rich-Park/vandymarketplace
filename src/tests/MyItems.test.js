  ...
  const data = [
    {
      ...
      description: 'test',
      email: 'user@vanderbilt.edu',
      imageURLs: ['https://firebasestorage.googleapis.com/v0/b/vandymarketplace.appspot.com/o/myleshshin%2Fflow.png?alt=media&token=98886048-af92-4dc3-b905-d2938f37504c'],
      likesCount: 0,
      price: 42,
...
jest.mock('../firebaseFunctions/dataload', () => ({
  AllSellItemsLoader: jest.fn(() => Promise.resolve([
    {
      id: 'gnlXgIc8FSQtAmqS0xLa',
      description: 'test',
      email: 'user@vanderbilt.edu',
  ...
  QueryItemsLoader: jest.fn(() => Promise.resolve([
    {
      id: 'gnlXgIc8FSQtAmqS0xLa',
      description: 'test',
      email: 'user@vanderbilt.edu',
